...
INSERT INTO articles (user_id, title, description, category, state)
...
VALUES (get_random_user_id(), 'Libro de Historia', 'Libro nuevo de historia universal',
        'TEXT_BOOKS_EDUCATIONAL_MATERIAL', 'NEW');
...
INSERT INTO articles (user_id, title, description, category, state, gender)
